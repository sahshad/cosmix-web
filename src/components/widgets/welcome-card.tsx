...
export function WelcomeCard({
  ...
  return (
    <div className="bg-gradient-to-br from-vivid-blue to-vivid-blue-dark rounded-[2rem] p-8 text-white shadow-2xl shadow-vivid-blue/20 relative overflow-hidden group">
