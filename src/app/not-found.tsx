  ...
  return (
    <main className="h-screen w-full flex flex-col items-center justify-center bg-background text-foreground relative overflow-hidden px-6 selection:bg-vivid-blue/30">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-40">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-vivid-blue/10 rounded-full blur-[120px]" />
        <div className="absolute top-1/3 left-1/3 w-75 h-75 bg-[#8b5cf6]/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 text-center max-w-md mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
        {/* Cosmos Icon Wrapper */}
        <div className="mx-auto w-24 h-24 bg-linear-to-br from-vivid-blue to-vivid-blue-dark rounded-4xl flex items-center justify-center shadow-2xl shadow-vivid-blue/20 rotate-12 hover:rotate-0 transition-transform duration-500">
