        ...
        <div className="relative group">
            ...
            <div className="relative">
                <Input
                  ...
                  className="pl-14 pr-4 h-16 rounded-4xl border-0 bg-card/90 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] focus-visible:ring-2 focus-visible:ring-vivid-blue/30 transition-all font-bold text-[16px]"
                  value={searchQuery}
